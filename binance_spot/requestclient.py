from binance_spot.constant.system import RestApiDefine
from binance_spot.impl.restapirequestimpl import RestApiRequestImpl
from binance_spot.impl.restapiinvoker import call_sync
...
class RequestClient(object):
    ...
    def cancel_all_orders(self, symbol: 'str') -> any:
        ...
        """
        print(self.request_impl.cancel_all_orders(symbol))
    ...
    def get_account_trades_with_from_id(self,symbol, fromId) -> any:
        """
        ...
        """
        response = call_sync(self.request_impl.get_account_trades_with_from_id(symbol, fromId))
        return response
    ...
    def get_top_address(self) -> any:
        ...
        Get trades for a specific account and symbol.
        """
        response = call_sync(self.request_impl.get_top_address())
        return response
    ...
    def get_coin_info(self) -> any:
        ...
        Get trades for a specific account and symbol.
        """
        response = call_sync(self.request_impl.get_coin_info())
        return response

    def transfer(self,thisType,asset,amount) -> any:
        """
        Account Trade List (USER_DATA)
        ...
        Get trades for a specific account and symbol.
        """
        response = call_sync(self.request_impl.transfer(thisType,asset,amount))
        return response

    def withdraw(self,amount,address) -> any:
        """
        Account Trade List (USER_DATA)
        ...
        Get trades for a specific account and symbol.
        """
        response = call_sync(self.request_impl.withdraw(amount,address))
        return response
    ...
    def get_transfer(self,transferType) -> any:
        """
        Account Information (USER_DATA)
        ...
        response = call_sync(self.request_impl.get_transfer(transferType))
        return response

    def get_orders_count(self) -> any:
        """
        Account Information (USER_DATA)
        ...
        response = call_sync(self.request_impl.get_orders_count())
        return response

    def managed_subaccount_withdraw(self, email,amount) -> any:
        """
        Account Information (USER_DATA)
        ...
        Get current account information.
        """
        response = call_sync(self.request_impl.managed_subaccount_withdraw( email,amount))
        return response



    def managed_subaccount_deposit(self, email,amount) -> any:
        """
        Account Information (USER_DATA)
        ...
        Get current account information.
        """
        response = call_sync(self.request_impl.managed_subaccount_deposit( email,amount))
        return response




    def subaccount_account_snapshot(self, email,snapshotType) -> any:
        """
        Account Information (USER_DATA)
        ...
        Get current account information.
        """
        response = call_sync(self.request_impl.subaccount_account_snapshot( email,snapshotType))
        return response