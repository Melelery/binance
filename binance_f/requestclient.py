...
class RequestClient(object):
    ...
    def get_order_by_system_id(self, symbol: 'str', systemOrderId: 'str') -> any:
        """
        Cancel Order (TRADE)
        ...
        """
        response = call_sync(self.request_impl.get_order_by_system_id(symbol,systemOrderId))
        return response
    ...
    def change_position_side(self) -> any:
        """
        Account Information (USER_DATA)
        ...
        Get current account information.
        """
        response = call_sync(self.request_impl.change_position_side())
        return response
